  ...
  methods: {
      ...
      function generate(data, id, axisNum) {
        ...
        dots.selectAll(".scatter_circle")
          ...
          .attr("class", function (d) {
            return "scatter_circle scatter_circle_" + d['issue'];
          })
          .attr("cx", function (d) {
            return x(d['time']);
          })
    ...
    displayNet: function () {
      ...
      function generate(data, id, lineType, axisNum) {
        ...
        var legendSize = 10,
          legendColor = {
            'upload': 'rgba(0, 160, 233, 1)',
            'download': 'rgba(34, 172, 56, 1)'
          };
      ...
      setInterval(function () {
        ...
        data.push({
          time: hAxis + ":" + mAxis,
          upload: Math.random() * 200 + 400,
          download: Math.random() * 400 + 200,
          total: 1000
        });
    ...
    displayDisk: function () {
      ...
      function generate(data, id, lineType, axisNum) {
        ...
        var legendSize = 10,
          legendColor = {
            'read': 'rgba(0, 160, 233, 1)',
            'write': 'rgba(255, 255, 255, 1)'
          };
      ...
      setInterval(function () {
        ...
        data.push({
          time: hAxis + ":" + mAxis,
          read: Math.random() * 700 + 200,
          write: Math.random() * 500 + 400,
          total: 1000
        });
    ...
    displayPeople: function () {
      ...
      function generate(data, id) {
        ...
        var legend = svg.selectAll(".moniLegend")
          ...
          .attr("transform", function (d, i) {
            return "translate(0," + i * legendhBase + ")";
          });
    ...
    displayDetec: function () {
      var data = [{
        ...
        {
          label: "lens detection",
          value: 75,
          color: '#ffee00'
        },
        {
          label: "violence_sos detection",
          value: 92,
          color: '#0068b7'
        },
        {
          label: "single money detection",
          value: 80,
          color: '#00b7ee'
        }
      ];
      ...
      var data2 = [{
        ...
        {
          label: "violence_sos_detection",
          value: 75,
          color: '#ff0000'
        },
        {
          label: "invalid_operation_detection",
          value: 92,
          color: '#22ac38'
        },
        {

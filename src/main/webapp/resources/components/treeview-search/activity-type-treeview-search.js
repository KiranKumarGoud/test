Vue.component("activity-type-treeview-search", {
                                  ...
                                  <div class="col-xl-12"> 
                                      ...
                                      <div class="m-widget14">
                                          <div class="m-widget14__header m--margin-bottom-30">
                                              <h3 class="m-widget14__title"> Activity type Tree view Input </h3>                                
                                          </div>
                                          <div class="row col-12">
                                              <div class="col-6">
                                                  <auto-complete
                                                      selected-value="EndpointTreeView"
                                                ...
                                                <li v-for="item in $store.state.treeViewSearch.allSelectedNodes">
                                                  <b>
                                                    <q-chip
                                                      ...
                                                      class="bg-white"
                                                      removable
                                                      @remove="deleteCurrentNode(item.endpointId)"
                                                    >
                                                      <div>
  ...
  methods: {
    ...
    expandTreeAndHighlightSearchedKey(parentNode, userSearchKey) {
        ...
        this.$refs.treeViewComponent.setExpanded(parentNode.endpointId, true)
    },
    searchTreeView(){
      this.postDataParms = []
      ...
      .then(response => {
        if(response.data.length > 0) {
          ...
          response.data.forEach(node => {
            let parentNode = this.$refs.treeViewComponent.getNodeByKey(node.endpointId)
    ...
    lazyLoadItemsEvent({ node, key, done, fail }){
      this.$store.dispatch('treeViewSearch/GET_LAZY_LOAD_TREE_ITEMS', node.endpointId)
      .then(response => {

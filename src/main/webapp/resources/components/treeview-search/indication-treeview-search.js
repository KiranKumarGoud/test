Vue.component("indication-treeview-search", {
                                  ...
                                  <div class="col-xl-12"> 
                                      ...
                                      <div class="m-widget14">
                                          <div class="m-widget14__header m--margin-bottom-30">
                                              <h3 class="m-widget14__title"> Indication Tree view Input </h3>                                
                                          </div>
                                          <div class="row col-12">
                                              <div class="col-6">
                                                  <auto-complete
                                                      selected-value="IndicationTreeView"
                                                ...
                                                <li v-for="item in $store.state.treeViewSearch.allSelectedNodes">
                                                  <b>
                                                    <q-chip
                                                      ...
                                                      class="bg-white"
                                                      removable
                                                      @remove="deleteCurrentNode(item.icd10Code)"
                                                    >
                                                      <div>
  ...
  methods: {
    ...
    expandTreeAndHighlightSearchedKey(parentNode, userSearchKey) {
        ...
        this.$refs.treeViewComponent.setExpanded(parentNode.icd10Code, true)
    },
    searchTreeView(){
        ...
        .then(response => {
          if(response.data.length > 0) {
            ...
            response.data.forEach(node => {
              let parentNode = this.$refs.treeViewComponent.getNodeByKey(node.icd10Code)
    ...
    lazyLoadItemsEvent({ node, key, done, fail }){
      this.$store.dispatch('treeViewSearch/GET_LAZY_LOAD_TREE_ITEMS', node.icd10Code)
      .then(response => {

                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    ...
                    m-brand__logo"> <a href="index.html"
                      ...
                      m-tabs-line--2x" role="tablist">
                          ...
                          m-tabs__link"
                                    ...
                                    <li class="nav-item2 m-tabs__item"> <a class="nav-link  m-tabs__link active"
                          m-tabs__link"
                    ...
                    <div class="m-subheader">
                      ...
                      m-subheader__title--separator"><i class="m-nav__link-icon
                        la la-home"
                                                        style="font-size:1.5rem"></i> Downloads</h3>
                        ...
                        <div class="default">
                            ...
                            <input onclick="exportTabularViewDataSingleFile()" style="..." value ="Export All CSV Data"  type="button"/>

                            <input onclick="exportTabularViewStrcutureDataSingleFileInSDFFormat()" style="..." value ="Export Structure Tab SDF Data"  type="button"/>

                            <input onclick="FlatFileTest()"  style="..." value ="FlatFile"  type="button""/>--%>
    ...
    var exportTabularViewDataSingleFile = function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                link.click();
                $.ajax({
                    url: '${contextPath}/security/tabularview/export/download/flatfile_data/reference/fromtempdata',
                    headers: {
                        'userSessionId': window.config.userSessionId,
                        'Content-Type': 'application/json'
                    },
                    ...
                    success: function (response1) {
                        ...
                        var zip = new JSZip();
                        zip.file("flatfile.tsv" ,new Blob([response1]));

                ...
                <div class="m-grid__item m-grid__item--fluid m-wrapper">
                        ...
                        <div class="col-8">
                          ...
                          m-tabs-line--2x" role="tablist">
                              ...
                              m-tabs__link" 
                                    ...
                                    <li class="nav-item2 m-tabs__item"> <a class="nav-link
                                      m-tabs__link active" 
                                    href="${contextPath}/molecularQueryAnalyzer/${usersession}" role="tab"> Molecular Pair Query Analyzer </a>
                                    </li>
                                        <li class="nav-item2 m-tabs__item"> <a class="nav-link
                              m-tabs__link" 
                    ...
                    <div class="m-subheader">
                      ...
                      m-subheader__title--separator"><i class="m-nav__link-icon
                        la la-home"
                                                        style="font-size:1.5rem"></i> Molecular Pair Query Analyzer</h3>
                                    ...
                                    <div class="m-portlet__head-title">
                                        <div class="row col-md-12">
                                            <div class="col-md-3">
                                                ...
                                                <input onclick="generateMolecularQueryResults()" style="margin-top:10px" value="Generate Plot" type="button"/>
                                            </div>
                                            <div class="col-md-5">
                                                <div id="moleculerQuery" style="min-width: 310px; height: 400px; max-width: 800px; margin: 0 auto"></div>
                                                <a class="nav-link"
                                                    href="${contextPath}/tabularview/${usersession}" > View Records in Tab Tabular View </a>
                                            </div>
                                            <div class="row col-md-4" id="showStrDetails">
                                                <div class="col-md-6">
                                                        STR ID :  <span id="strIdVal1">0</span> <br/>
                                                        Activity Value : <span id="microVal1">0</span> <br/>
                                                        <img id="molecularImgPath1" src=""/> <br/>
                                                </div>
                                                <div class="col-md-6">
                                                        STR ID :  <span id="strIdVal2">0</span> <br/>
                                                        Activity Value : <span id="microVal2">0</span> <br/>
                                                        <img id="molecularImgPath2" src=""/> <br/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        $.ajax({
            ...
            url: '${contextPath}/security/analyzers/moleularanalyzerdata',
    ...
    function generateMolecularQueryResults() {
